...
OpenPoet does not support Windows natively. Windows users should install and run OpenPoet inside [WSL 2](https://learn.microsoft.com/en-us/windows/wsl/install) as a regular Linux binary.
