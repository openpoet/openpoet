		...
		},
		{
			...
			InputSchema: ToolDefinitionInput{
				...
				Properties: map[string]ToolPropertySchema{
					...
					"status":      {Type: "string", Description: "Status: todo, in_progress, awaiting_approval, done, blocked (default: todo)"},
		...
		},
		{
			...
			InputSchema: ToolDefinitionInput{
				...
				Properties: map[string]ToolPropertySchema{
					...
					"status":      {Type: "string", Description: "New status: todo, in_progress, awaiting_approval, done, blocked"},
